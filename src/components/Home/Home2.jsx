...
export default function Home() {
  ...
  const subtitle = useText({ first:"p", delay:2 });
  const contact = useText({ first:"div", delay:3 });
    ...
    <div name="home" className="w-full h-screen cursor-default">
      <div className="w-full h-full max-w-7xl mx-auto flex flex-col px-[10px] xs:px-5 pt-36 text-[#2a2a2a] dark:text-[#ebebeb] md:pt-32 lg:px-7 xl:px-10 xl:pt-28">
        ...
        <div className="w-full py-10 md:py-5 text-[#2a2a2a] dark:text-[#9a9a9a]">
          <p ref={subtitle} className="text-base font-medium w-full sm:w-[90%] md:text-lg lg:text-xl lg:leading-[1.95rem] lg:w-[95%]">
        ...
        <div ref={contact} className="w-full mt-5 py-6 sm:mt-0 lg:py-0 xl:py-3">
