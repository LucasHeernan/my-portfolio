    ...
    <div>
      {
        letras.map((letra, idx) => {
          ...
          return (
            <span
              key={idx}
              className={`inline-block transform transition-all ease-in-out ${ uniqueId === isHovered ? "animate-rubberBand text-blue-400 delay-300" : "animate-bounceLetter" } min-w-[7px] xs:min-w-[10px] sm:min-w-[15px] lg:min-w-[17px] scale-y-110 sm:scale-y-105 md:scale-y-100`}
