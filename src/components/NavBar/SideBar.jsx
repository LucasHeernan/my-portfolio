...
export default function SideBar({ handleMenu }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full h-screen py-14 transform transition-[height] -translate-y-full will-change-transform bg-[#373737]">
      ...
      <ul className="flex flex-col justify-center gap-2 px-5 h-full">
        <Link
          ...
          duration={1000}
          onClick={handleMenu}
          className="text-[#999] flex will-change-transform transform origin-top-left font-bold text-5xl p-2 cursor-pointer
