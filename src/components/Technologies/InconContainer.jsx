...
export default function IconContainer({ custom, children }) {
  ...
  return (
    <div
      ...
      className={`relative ${custom ? custom : "w-8 h-8"} flex rounded-full items-center justify-center overflow-hidden border-2 border-black dark:border-0 dark:bg-indigo-100 hover:border-0 group`}
    >
